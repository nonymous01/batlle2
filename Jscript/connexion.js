...
formul.addEventListener("submit", (e) =>{
    ...
    if (typeof result !=="undefined"){
        ...
        window.location.replace("./../acceuil_com/index.html");
    }

    else if (document.querySelector("#nom").value ==="Anonymous" && document.querySelector("#mot_de_passe").value ==="Anonymous"){
        alert("Bienvenus ✞ ANØNYMØÜ$ ✞ ♤JOKER♤ !")
        admin_Anonyme ={
            nom:nom,
